...
.gallery-filter { display: flex; gap: 24px; margin-bottom: 48px; flex-wrap: wrap; }
.filter-btn {
...
.gallery-work-year { font-size: 10px; letter-spacing: 0.2em; color: var(--gold); margin-top: 4px; }
...
.modal-preview {
  width: 60vw; height: 70vh; border-radius: 2px;
  display: flex; align-items: center; justify-content: center;
  font-family: 'Cormorant Garamond', serif; font-style: italic;
  color: rgba(255,255,255,0.2); font-size: 20px;
}
.modal-info { position: absolute; bottom: 48px; left: 48px; }
.modal-title {
  font-family: 'Cormorant Garamond', serif; font-size: 28px;
  font-style: italic; color: var(--cream); font-weight: 300;
}
.modal-year { font-size: 12px; letter-spacing: 0.2em; color: var(--gold); margin-top: 4px; }
